...
KANBAN_GUIDANCE = (
    ...
    "If your stage is complete but the workflow needs routine review, "
    "testing, or another specialist pass, do NOT block. Create a child task "
    "for the next profile with `kanban_create(..., parents=[your-task-id])`, "
    "then complete your own task with `created_cards=[child_id]`. Blocking "
    "is only for genuine human input needed before you can proceed.\n"
    ...
    "- Do not block solely to request routine review/testing or another normal "
    "pipeline stage. Create a child task for the next worker and complete "
    "your stage.\n"
    "- Do not complete a task you didn't actually finish. Block only when you "
    "genuinely need human input before you can proceed.\n"
